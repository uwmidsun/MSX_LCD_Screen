...
#define LCD_SET_D0()	LCD_D0_PINOUT_REG|=LCD_D0_PINBIT_MASK
#define LCD_SET_D1()	LCD_D1_PINOUT_REG|=LCD_D1_PINBIT_MASK
#define LCD_SET_D2()	LCD_D2_PINOUT_REG|=LCD_D2_PINBIT_MASK
#define LCD_SET_D3()	LCD_D3_PINOUT_REG|=LCD_D3_PINBIT_MASK
#define LCD_SET_D4()	LCD_D4_PINOUT_REG|=LCD_D4_PINBIT_MASK
#define LCD_SET_D5()	LCD_D5_PINOUT_REG|=LCD_D5_PINBIT_MASK
#define LCD_SET_D6()	LCD_D6_PINOUT_REG|=LCD_D6_PINBIT_MASK
#define LCD_SET_D7()	LCD_D7_PINOUT_REG|=LCD_D7_PINBIT_MASK
...
#define LCD_CLR_D0()	LCD_D0_PINOUT_REG&=~LCD_D0_PINBIT_MASK
#define LCD_CLR_D1()	LCD_D1_PINOUT_REG&=~LCD_D1_PINBIT_MASK
#define LCD_CLR_D2()	LCD_D2_PINOUT_REG&=~LCD_D2_PINBIT_MASK
#define LCD_CLR_D3()	LCD_D3_PINOUT_REG&=~LCD_D3_PINBIT_MASK
#define LCD_CLR_D4()	LCD_D4_PINOUT_REG&=~LCD_D4_PINBIT_MASK
#define LCD_CLR_D5()	LCD_D5_PINOUT_REG&=~LCD_D5_PINBIT_MASK
#define LCD_CLR_D6()	LCD_D6_PINOUT_REG&=~LCD_D6_PINBIT_MASK
#define LCD_CLR_D7()	LCD_D7_PINOUT_REG&=~LCD_D7_PINBIT_MASK
...
#define LCD_GET_D0()	(LCD_D0_PININ_REG&LCD_D0_PINBIT_MASK?1:0)
#define LCD_GET_D1()	(LCD_D1_PININ_REG&LCD_D1_PINBIT_MASK?1:0)
#define LCD_GET_D2()	(LCD_D2_PININ_REG&LCD_D2_PINBIT_MASK?1:0)
#define LCD_GET_D3()	(LCD_D3_PININ_REG&LCD_D3_PINBIT_MASK?1:0)
#define LCD_GET_D4()	(LCD_D4_PININ_REG&LCD_D4_PINBIT_MASK?1:0)
#define LCD_GET_D5()	(LCD_D5_PININ_REG&LCD_D5_PINBIT_MASK?1:0)
#define LCD_GET_D6()	(LCD_D6_PININ_REG&LCD_D6_PINBIT_MASK?1:0)
#define LCD_GET_D7()	(LCD_D7_PININ_REG&LCD_D7_PINBIT_MASK?1:0)
...
#define LCD_SET_OUT_DIR()		LCD_D0_PINDIR_REG|=LCD_D0_PINBIT_MASK; \
...
#define LCD_SET_IN_DIR()		LCD_D0_PINDIR_REG&=~LCD_D0_PINBIT_MASK; \
								LCD_D1_PINDIR_REG&=~LCD_D1_PINBIT_MASK; \
								LCD_D2_PINDIR_REG&=~LCD_D2_PINBIT_MASK; \
								LCD_D3_PINDIR_REG&=~LCD_D3_PINBIT_MASK; \
								LCD_D4_PINDIR_REG&=~LCD_D4_PINBIT_MASK; \
